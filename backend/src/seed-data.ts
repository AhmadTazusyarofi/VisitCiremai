...
/**
 * Data awal paket VisitCiremai — dipindahkan dari frontend/src/data/packages.ts.
 * Setelah di-seed, data ini dikelola lewat tabel MySQL / halaman admin;
 * berkas ini hanya dipakai untuk mengisi database pertama kali.
 */
export const seedPackages: PackageDto[] = [
  // --- Pendakian Gunung Hutan ---
  {
    ...
    // NOTE: gambar di bawah masih contoh — ganti dengan foto asli.
