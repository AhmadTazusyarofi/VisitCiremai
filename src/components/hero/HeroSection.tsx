...
export function HeroSection(): JSX.Element {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-linear-to-b from-black/50 via-black/45 to-black/60"
      />
      ...
      <Container className="relative z-10 py-24 text-center text-white">
        ...
        <h1 className="mx-auto max-w-4xl font-bold leading-tight [text-shadow:0_2px_8px_rgba(0,0,0,0.7)]">
        ...
        {/* Subheading */}
        <p className="mx-auto mt-6 max-w-2xl whitespace-normal text-base text-white/90 [text-shadow:0_2px_8px_rgba(0,0,0,0.7)] sm:text-lg lg:max-w-none lg:whitespace-nowrap">
          Paket wisata, akomodasi, transportasi, dan penyewaan alat outdoor
          dalam satu platform.
        </p>
